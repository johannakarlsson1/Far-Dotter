...
$query = new WP_Query( array( 'category_name' => 'Musik' ) ); ?>

<div class="post-page container">
<div class="row">

  <div class="col-md-3 right-align">
    <div id="sidebar-category-musik">
      <?php if ( function_exists('dynamic_sidebar') ) dynamic_sidebar('sidebar-category-musik');?>
    </div>
  </div>
  <?php
// The Loop
